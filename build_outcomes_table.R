  ...
  df <- data.frame(
            ...
            c(#labels depend on whether or not the country includes relapses with new
               ifelse(NZ(pdata()$profile_data[, "rel_with_new_flg"]) == 1,
                      ...
                      paste("|People with a new case of TB started on treatment for TB|", ", ", dcyear - 2)
               ...
               paste("|People started on treatment for TB that is resistant to rifampicin (MDR/RR-TB)|", ", ", dcyear - 2),
